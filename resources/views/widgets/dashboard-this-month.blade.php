...
?><a href="{{ admin_url('tenants') }}" title="View All Tenants"
    ...
    <div class="card-body py-0 pb-2 pb-md-4">
        <p class="h3  text-bold mb-2 mb-md-3 text-primary ">This Month</p>
        <p class="  m-0 text-right text-primary h3" style="line-height: 3.2rem">
            {{ 'UGX ' . number_format($rentings->sum('payable_amount')) }}</p>

        <p class="mt-4 mb-2 text-dark text-uppercase">
            COMMISION: <span class="text-success" style="font-weight: 800">
                {{ 'UGX ' . number_format($rentings->sum('commision_amount')) }}
            </span><br>
        </p>
        <hr class="mt-0 mb-2 mb-md-2" style="background-color: var(--primary); height: 2px;">
        <p class="h4  text-bold mb-2 bg-primary text-white pl-3 pt-2 pb-1">SUMMARY</p>
        ...
        <p class="mt-0 mb-0 text-dark text-uppercase">TOTAL
